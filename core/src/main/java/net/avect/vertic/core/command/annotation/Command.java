package net.avect.vertic.core.command.annotation;
...
public @interface Command {
    ...
    final class Defaults {
        public static final String FALLBACK_PREFIX = "vertic";

        public static final String PERMISSION = "";

        public static final String PERMISSION_MESSAGE = "&7I'm sorry but you don't have permission to perform this command.";

        public static final boolean ASYNC = false;

        public static final String DESCRIPTION = "Undefined.";

        public static final String EXCEPTION_MESSAGE = "&7We are sorry but there has been" +
                " an error executing your" +
                " command. Please see console for more information.";
