...
import net.avect.vertic.core.command.annotation.*;
import net.avect.vertic.core.command.annotation.Optional;
...
import net.avect.vertic.core.command.parametric.defaults.BooleanParser;
import net.avect.vertic.core.command.parametric.defaults.FloatParser;
import net.avect.vertic.core.command.parametric.defaults.IntegerParser;
import net.avect.vertic.core.command.parametric.defaults.LongParser;
...
public class InternalCommandService implements CommandService {
    ...
    private <T> void registerParsers(final ArgumentParser<T> parser, final Class<? extends T>... types) {
    ...
    public synchronized <T> void registerNodes(final Class<? extends T> aClass, Injector injector) {
         ...
         *
         * All of the root nodes will be cached in a map.
    ...
    private <T> CommandNode<T> createNode(boolean root, List<CommandNode<T>> childNodes, CommandNode<T> parent, T instance, Class<? extends T> aClass, Method method, String currentName, String[] currentAliases, Command command) {
        ...
        if (method == null) {
            commandContext = new InternalCommandContext(Command.Defaults.FALLBACK_PREFIX, currentName, Command.Defaults.PERMISSION,
                    Command.Defaults.PERMISSION_MESSAGE, Command.Defaults.DESCRIPTION,
                    Command.Defaults.EXCEPTION_MESSAGE, currentAliases, Command.Defaults.ASYNC, Command.Defaults.USAGE, Lists.newArrayList(), parent == null ? null : parent.getContext());
        } else {
