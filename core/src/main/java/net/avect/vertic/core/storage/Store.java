...
public interface Store<T extends Storable> extends Iterable<T> {
    ...
    /**
     * Remove an ojbect from the store by it's {@link UUID} unique id.
     */
    ...
    /**
     * Returns a boolean whether the object is present in the stor or not. If it is, the consumer is accepted.
     */
