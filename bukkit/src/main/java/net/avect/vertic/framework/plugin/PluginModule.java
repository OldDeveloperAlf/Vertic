package net.avect.vertic.framework.plugin;

import com.google.inject.AbstractModule;
import com.google.inject.Provides;
import net.avect.vertic.framework.plugin.annotation.DefaultWorld;
import net.avect.vertic.framework.plugin.annotation.MainScoreboard;
import net.avect.vertic.framework.plugin.annotation.PluginFolder;
...
public class PluginModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(Scoreboard.class).annotatedWith(MainScoreboard.class)
                .toInstance(this.plugin.getServer().getScoreboardManager().getMainScoreboard());
        bind(ItemFactory.class).toInstance(this.plugin.getServer().getItemFactory());
        bindCommandMap();
    }

    private final void bindCommandMap() {
        try {
